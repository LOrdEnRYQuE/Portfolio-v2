...
export async function generateMetadata({ 
  ...
  return constructMetadata({
    title: industry.seoTitle || `${industry.title} | LOrdEnRYQuE Solutions`,
    description: industry.metaDescription || industry.intro,
    image: industry.ogImage || industry.coverImage || "/og-image.png",
    canonical: industry.canonicalUrl || `/industries/${slug}`,
    noIndex: industry.isIndexed === false
  });
}
...
export default async function IndustrySlugPage({ params }: IndustrySlugPageProps) {
  ...
  const faqItems = JSON.parse(industry.faqItems || "[]") as { question: string, answer: string }[];
          ...
          <div className="lg:col-span-1 space-y-8">
            <div className="sticky top-32 p-8 rounded-3xl border border-white/10 bg-white/5 backdrop-blur-md shadow-2xl">
              ...
              <p className="text-sm text-foreground/60 mb-8 leading-relaxed">
                Empower your business with tailored, high-performance digital solutions designed for your specific industry.
              </p>
