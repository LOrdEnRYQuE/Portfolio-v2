            ...
            >
              <div>
                ...
                >
                  ...
                  {t("contact.view.badge")}
                </motion.div>
                
                <h1 className="text-6xl xl:text-7xl font-black text-foreground mb-8 leading-[1.05] tracking-tight text-balance">
                  {t("contact.view.title_line1")} <br />
                  <span className="text-accent underline decoration-accent/20 underline-offset-8">{t("contact.view.title_line2")}</span>
                </h1>
                
                <p className="text-text-secondary text-xl leading-relaxed max-w-lg">
                  {t("contact.view.description")}
                </p>
              </div>
              ...
              <div className="relative group">
                ...
                >
                  <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.3em]">
                    ...
                    {t("contact.view.secure")}
                  </div>
                  <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.3em]">
                     <div className="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse" />
                    {t("contact.view.performance")}
                  </div>
                </motion.div>
              </div>
            </motion.div>
